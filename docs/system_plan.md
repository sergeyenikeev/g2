...
Rewarded #1 — Continue (после Game Over): доступен 1 раз за раунд, только если score ≥ 450; после просмотра → заменить текущие 3 фигуры на фикс-набор: [1×1, 1×2, 2×2], комбо сбросить в x1.00.
