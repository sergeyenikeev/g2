...
const DICTS: Record<Language, Dictionary> = {
  en: {
    ...
    "results.continue": "Continue: 3 New Pieces",
    "results.double": "Double: x2 Tokens",
    ...
    "settings.account.guest_hint":
      "Signing in is optional. Without it, the game keeps working and you can use the name field manually.",
    "settings.account.use_name": "Use Yandex display name when available",
    "settings.account.sign_in": "Sign in to Yandex",
    ...
    "settings.account.connected_hint":
      "Your platform profile is linked. You can keep your own name or switch to the Yandex display name below.",
    ...
    "hint.menu_reward": "Reward: +{count} tokens",
    "hint.continue_reward": "Continue gives 3 new pieces for this board.",
    "hint.double_reward": "Double Tokens doubles the tokens earned in this run.",
  ...
  ru: {
    ...
    "menu.rewarded": "Получить +2 токена",
    "menu.themes": "Темы",
    ...
    "results.continue": "Продолжить: 3 новые фигуры",
    "results.double": "Удвоить награду токенов",
    ...
    "results.summary.daily_leaderboard": "Предварительное место в Daily #{rank}",
    "results.summary.token_bonus": "Бонусные токены +{count}",
    "results.summary.double_applied": "Награда удвоена",
    "leaderboard.title": "Лидеры",
    "leaderboard.hint":
      "Лучшие забеги на этом устройстве. На поддерживаемых платформах storage синхронизирует их с аккаунтом.",
    "leaderboard.hint.device": "Лучшие забеги сохранены на этом устройстве.",
    "leaderboard.hint.account": "Лучшие забеги синхронизируются через storage аккаунта платформы.",
    "leaderboard.hint.platform":
    ...
    "leaderboard.daily": "Легенды Daily",
    ...
    "leaderboard.empty.daily": "Пока нет Daily-забегов. Пройди ежедневное испытание и открой этот рейтинг.",
    ...
    "settings.account.guest_hint":
      "Вход не обязателен. Без него игра работает как обычно, а имя можно просто заполнить вручную.",
    "settings.account.use_name": "Использовать имя профиля Яндекса, когда оно доступно",
    "settings.account.sign_in": "Войти через Яндекс",
    "settings.account.connected": "Подключено: {name}",
    "settings.account.connected_fallback": "игрок Яндекса",
    "settings.account.connected_hint":
      "Профиль платформы подключен. Ниже можно оставить свое имя или переключиться на имя Яндекса.",
    ...
    "hint.menu_reward": "Награда: +{count} токена",
    "hint.continue_reward": "Продолжение выдает 3 новые фигуры для этого поля.",
    "hint.double_reward": "Удвоение увеличивает токены за этот раунд в 2 раза.",
